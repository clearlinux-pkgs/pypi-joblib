...
Source0  : https://files.pythonhosted.org/packages/dc/fe/0f5a938c54105553436dbff7a61dc4fed4b1b2c98852f8833beaf4d5968f/joblib-1.5.1.tar.gz
...
%prep
%setup -q -n joblib-1.5.1
cd %{_builddir}/joblib-1.5.1
pushd ..
cp -a joblib-1.5.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748009921
