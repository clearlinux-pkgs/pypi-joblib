...
Source0  : https://files.pythonhosted.org/packages/30/08/8bd4a0250247861420a040b33ccf42f43c426ac91d99405374ef117e5872/joblib-1.5.0.tar.gz
...
%prep
%setup -q -n joblib-1.5.0
cd %{_builddir}/joblib-1.5.0
pushd ..
cp -a joblib-1.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746460355
