...
Source0  : https://files.pythonhosted.org/packages/7c/c3/94c9e4886e8f33832690ab48fdac4a121a7bfec3e2c044c9f2762aa9068e/joblib-1.4.0.tar.gz
...
%prep
%setup -q -n joblib-1.4.0
cd %{_builddir}/joblib-1.4.0
pushd ..
cp -a joblib-1.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712611102
